...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p
          className="text-xl font-monserrat text-[#FF7F50]"
        >
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-semibold">
          ...
          <br/>
          <span className="text-[#FF7F50] inline-block mt-3">Nike</span> Shoes
        </h1>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-gray-400 bg-hero bg-cover bg-center">
        <img
          src={bigShoeImg}
          alt="Shoe collection"
          width={610}
